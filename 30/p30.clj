...
; could maybe do something smart with summing all combinations of the 5th power of each of the 10 digits,
; and seeing what ones sum to contain those numbers
